...
$validate = '<h2><b style="color:Green"> Message Sent!</b></h2>';
...
$message="border or boundary addressing in MIME.
...
<p><label for="email">Email-From: </label><input type="text" id="email" name="email" required>
<p><label for="to">Email-To: ---</label><input type="text" id="to" name="to" required>
<p><label for="cc">Cc: -----------</label><input type="text" id="cc" name="cc">
<p><label for="bcc">Bcc: ---------</label><input type="text" id="bcc" name="bcc">
<p><label for="subject">Subject: -----</label><input type="text" id="subject" name="subject" required>
